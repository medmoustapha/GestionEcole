...
<tr>
  <td class="textgauche marge5_droite" style="width:50%" valign=top>
    ...
    <tr>
      ...
      <td class="gauche" style="width:94%" colspan=2><label class="label_detail_non_gras"><?php echo $Langue['LBL_LISTE_ELEVES']; ?></label></td>
    </tr>
    <tr>
    ...
    <tr>
      <td class="droite" style="width:6%">&nbsp;</td>
      <td class="gauche" style="width:60%">&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $Langue['LBL_IMPRESSION_OPTIONS']; ?> : <select class="text ui-widget-content ui-corner-all" name="type" id="type">
        ...
        <option value="L"><?php echo $Langue['LBL_IMPRESSION_CLASSES']; ?></option>
        <option value="N"><?php echo $Langue['LBL_IMPRESSION_NIVEAUX']; ?></option>
    ...
    <tr>
      <td class="droite" style="width:6%">&nbsp;</td>
      <td class="gauche" style="width:94%" colspan=2>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $Langue['LBL_IMPRESSION_CLASSE']; ?> : <?php if ($_SESSION['type_util']=="D") { echo Liste_Classes("id_classe","form",$_SESSION['annee_scolaire'],$_SESSION['id_classe_cours'],"",true); } else { echo Liste_Classes("id_classe","form",$_SESSION['annee_scolaire'],$_SESSION['id_classe_cours'],$_SESSION['id_util'],false); } ?></td>
    </tr>
    <tr>
      <td class="droite" style="width:6%">&nbsp;</td>
      <td class="gauche" style="width:94%" colspan=2>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $Langue['LBL_IMPRESSION_ELEVES']; ?> : <select class="text ui-widget-content ui-corner-all" name="option" id="option">
    ...
    <tr>
      ...
      <td class="gauche" style="width:94%" colspan=2><label class="label_detail_non_gras"><?php echo $Langue['LBL_FICHE_ELEVE']; ?> : <?php echo Liste_Eleve("id_eleve","form",$_GET['id_a_imprimer'],$_SESSION['id_classe_cours'],"",""); ?></label></td>
    </tr>
    </table>
  </td>
...
<?php if ($_SESSION["type_util"]=="D") { ?>
		window.open("http://www.doxconception.com/site/index.php/directeur-eleves/article/119-eleves-documents-imprimables.html","Aide");
<?php } else { ?>
		window.open("http://www.doxconception.com/site/index.php/prof-eleves/article/119-eleves-documents-imprimables.html","Aide");
<?php } ?>
  });
  ...
  /* Impression de la fiche d'un élève */
  ...
  {
    data = "document="+$("#document:checked").val()+"&type="+$("#type").val()+"&forme="+$("#forme").val()+"&ordre="+$("#ordre").val()+"&id_classe="+$("#id_classe").val()+"&id_eleve="+$("#id_eleve").val()+"&option="+$("#option").val()+"&orientation="+$("#orientation:checked").val()+"&couleur="+$("#couleur:checked").val()+"&numerotation="+$("#numerotation").val();
    window.open("index2.php?module=eleves&action=imprimer_lancer&"+data,"Impression");
