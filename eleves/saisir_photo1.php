...
<?php } ?>
  ...
  {
    Charge_Dialog3("index2.php?module=eleves&action=saisir_photo_webcam&id_personne=<?php echo $_GET['id_personne']; ?>","<?php echo $Langue['BTN_PHOTO_WEBCAM']; ?>");
  });
	...
	$( "#dialog-confirm" ).dialog(
    {
	  ...
	  buttons:[
      {
		...
		click: function()
        {
          ...
          var request = $.ajax({type: "POST", url: "index2.php", data: "module=eleves&action=delete_photo&id=<?php echo $_GET['id_personne']; ?>"});
          request.done(function(msg)
          {
		    Message_Chargement(1,1);
		    $( "#dialog-confirm" ).dialog( "close" );
			Charge_Dialog3("index2.php?module=eleves&action=saisir_photo1&id_personne=<?php echo $_GET['id_personne']; ?>","<?php echo $Langue['LBL_PHOTO_TITRE']; ?>");
...
function formUploadCallback (result) {
  switch (result)
  {
    ...
    case "upload":
      ...
      break;
    default:
      Charge_Dialog3("index2.php?module=eleves&action=saisir_photo3&id_personne=<?php echo $_GET['id_personne']; ?>","<?php echo $Langue['LBL_PHOTO_TITRE']; ?>");
      break;
  }
}
</script>
