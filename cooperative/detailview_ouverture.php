...
// Récupération des informations
  ...
  $tpl->set_file("gform","detailview_ouverture.html");
...
$(document).ready(function()
{
  ...
  {
    Charge_Dialog("index2.php?module=cooperative&action=editview_ouverture&id=<?php echo $_GET['id']; ?>","<?php echo $Langue['LBL_SAISIE_MODIFIER_OUVERTURE_EXERCICE']; ?>");
  });
