...
<?php if ($_GET['voircolonne']=="1") { ?>
	...
	<tr class="even">
	  <td class="gauche" width=100%><label class="label_detail_non_gras"><?php echo $Langue['EXPL_DEVOIRS']; ?></label></td>
	  <td class="gauche"><input type="button" id="devoirs" name="devoirs" value="<?php echo $Langue['BTN_AJOUTER']; ?>" onClick="Accueil_Ajout_Panneau('devoirs','J','<?php echo $Langue['LBL_DEVOIRS_TITRE']; ?>','1')"></td>
	</tr>
	<tr class="odd">
	...
	<tr class="even">
	  <td class="gauche" width=100%><label class="label_detail_non_gras"><?php echo $Langue['EXPL_BIBLIO_E']; ?></label></td>
	  <td class="gauche"><input type="button" id="bibliotheque" name="bibliotheque" value="<?php echo $Langue['BTN_AJOUTER']; ?>" onClick="Accueil_Ajout_Panneau('bibliotheque_E','5','<?php echo $Langue['LBL_BIBLIO_TITRE_E']; ?>','1')"></td>
	</tr>
	<tr class="odd">
	...
	<tr class="even">
	  <td class="gauche" width=100%><label class="label_detail_non_gras"><?php echo $Langue['EXPL_NEWS_E']; ?></label></td>
	  <td class="gauche"><input type="button" id="actualites" name="actualites" value="<?php echo $Langue['BTN_AJOUTER']; ?>" onClick="Accueil_Ajout_Panneau('news','5','<?php echo $Langue['LBL_NEWS_TITRE2']; ?>','1')"></td>
	</tr>
	<tr class="odd">
	  <td class="gauche" width=100%><label class="label_detail_non_gras"><?php echo $Langue['EXPL_TACHE']; ?></label></td>
	  <td class="gauche"><input type="button" id="taches" name="taches" value="<?php echo $Langue['BTN_AJOUTER']; ?>" onClick="Accueil_Ajout_Panneau('taches','J|5','<?php echo $Langue['LBL_TACHE_TITRE']; ?>','1')"></td>
	</tr>
	</table>
<?php } else { ?>
