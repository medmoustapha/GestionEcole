...
?>
<tr>
  <td class="droite" width=15%><label class="label_class"><?php echo $Langue['LBL_DEVOIRS_AFFICHER']; ?> <font color="#FF0000">*</font> :</label></td>
  <td class="gauche" width=85%>
    ...
    <?php
    foreach ($liste_choix['devoirs_a_afficher'] AS $cle => $value)
    {
