<div class="portlet ui-widget ui-widget-content ui-helper-clearfix ui-corner-all" id="listItem2_<?php echo $i_panneau; ?>">
  ...
  <div class="portlet-content" style="padding:0px;margin:0px">
		<iframe src="http://www.blague.info/blagues-du-jour/blagues.php?f=FFFFFF&c=000000&t=2&p=Arial, Verdana, sans-serif" style="width:300px;height:250px;margin:3px;border:none;margin-bottom:0;display:block" frameborder="0" scrolling="auto"></iframe><noframes>Votre navigateur ne supporte pas le format iframe</noframes>
  </div>
</div>
