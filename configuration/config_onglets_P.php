<?php
  $req=mysql_query("SELECT * FROM `etablissement".$_SESSION['annee_scolaire']."` WHERE parametre='onglet_P'");
  $onglet_D_P=explode(",",mysql_result($req,0,'valeur'));
  $req=mysql_query("SELECT * FROM `etablissement".$_SESSION['annee_scolaire']."` WHERE parametre='onglet_E'");
  $onglet_D_E=explode(",",mysql_result($req,0,'valeur'));
...
<tr>
  <td class="marge10_droite" style="width:50%;"><div class="ui-widget ui-widget-header ui-state-default ui-corner-all ui-div-separation-form"><?php echo $Langue['LBL_ONGLETS_ENSEIGNANTS']; ?></div></td>
  <td class="marge10_gauche" style="width:50%;"><div class="ui-widget ui-widget-header ui-state-default ui-corner-all ui-div-separation-form"><?php echo $Langue['LBL_ONGLETS_PARENTS']; ?></div></td>
</tr>
<tr>
  <td class="marge10_droite gauche" style="width:50%;vertical-align:top;">
  <?php
  ...
  <td class="marge10_gauche gauche" style="width:50%;vertical-align:top;">
  <?php
...
$(document).ready(function()
{
  ...
  $("#aide_fenetre").click(function(event)
  {
    ...
    window.open("http://www.doxconception.com/site/index.php/prof-configuration/article/237-prof-configurer-les-onglets-accessibles-aux-differents-utilisateurs.html","Aide");
  });
