...
$opts = array(
	...
	'roots' => array(
		...
		array(
			'driver'        => 'LocalFileSystem',   // driver for accessing file system (REQUIRED)
			'path'          => '../../../cache/ged/enseignants/'.$_GET['repertoire_perso'].'/personnel',         // path to files (REQUIRED)
			'URL'           => dirname($_SERVER['PHP_SELF']) . '../../../../cache/ged/enseignants/'.$_GET['repertoire_perso'].'/personnel', // URL to files (REQUIRED)
			'alias'         => $Langue_Module['LBL_REPERTOIRE_PERSONNEL'],
			'accessControl'   => 'access',
		)
	)
);
