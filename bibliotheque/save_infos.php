<?php
  ...
  if ($id=="")
  {
    $id=Construit_Id("bibliotheque",20);
    $req = mysql_query("INSERT INTO `bibliotheque` (id) VALUES ('$id')");
  }
  ...
  foreach ($tableau_variable['bibliotheque'] AS $cle)
  {
    if ($cle['nom']!="id")
    {
      ...
      if ($faire==true)
      {
        $req = mysql_query("UPDATE `bibliotheque` SET ".$cle['nom']."='".$_POST[$cle['nom']]."' WHERE id='$id'");
      }
    }
  }
